...
| GPU miner (OpenCL) | Functional, correctness-validated and batch-size-tuned on real hardware (RTX 4070 Super); ~16.6M H/s measured on the same machine (~98% of its measured ceiling), ~22x the CPU reference miner |
